---
name: fund-holdings
description: 获取基金最新持仓信息，支持查询前1-20条重仓股及其持仓比例。默认查询前20条重仓股，用户可以通过参数指定查询条数（如"前10条"、"top 15"）。支持通过基金代码或基金名称查询，使用天天基金网的公开数据源。适用于用户查询"基金xxxx的最新持仓"、"查看某基金的前N条重仓股"等场景。
---
...
## 数据源
主要使用天天基金网（fund.eastmoney.com）的公开数据，该数据源：
- 提供免费的基金持仓信息
- 数据更新及时（季报发布后）
- 无需登录即可访问
- 最多支持查询前20条重仓股信息
